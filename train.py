...
from model.model_builder import LongDocumentSummarizer
...
def validate(args,  device_id, pt, step):
    ...
    model = LongDocumentSummarizer(args, device, load_pretrained_bert=False, bert_config = config)
    model.load_cp(checkpoint)
    model.eval()

    valid_iter = data_loader.Dataloader(args, load_data(args, 'valid', shuffle=False),
...
def train(args, device_id):
    ...
    model = LongDocumentSummarizer(args, device, load_pretrained_bert=True)
    if args.train_from != '':
